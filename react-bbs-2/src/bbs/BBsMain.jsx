  ...
  */
  ...
  render() {
    ...
    state에 선언된 변수를 사용하려면 {this.state.bbsList}와 같이 사용해야 하는데
      필드 영역에 선언된 this.state를 분해하여
      그중 bbsList를 별도로 추출을 해 두면
      tag 코드에서 사용할때 {bbsList} 형식 사용할수있다.
      */
